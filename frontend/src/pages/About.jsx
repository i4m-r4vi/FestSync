  ...
  return (
    <div className="min-h-screen flex flex-col bg-background">
      ...
      <main className="flex-grow container mx-auto px-6 py-28 md:py-32">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="text-lg text-muted-foreground mb-8">
            FestSync AI is a modern, all-in-one platform designed to streamline event management for colleges and universities. Our mission is to simplify the process of discovering, registering for, and managing campus events for students, while providing powerful tools for administrators to organize and track participation.
          </p>
          <p className="text-lg text-muted-foreground mb-12">
            From secure payment processing with Stripe to automated certificate generation, FestSync AI provides a seamless experience for everyone involved. This project is open-source, and we welcome contributions from the community.
          </p>

          <a
            href="https://github.com/i4m-r4vi/FestSync"
            target="_blank"
      ...
      <footer className="bg-background border-t border-border text-center py-6">
        <p className="text-muted-foreground">© {new Date().getFullYear()} FestSync AI. All rights reserved.</p>
      </footer>
    </div>
  );
}
